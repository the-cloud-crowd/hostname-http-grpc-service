...
public class CounterServiceImpl extends CounterServiceImplBase {
    ...
    public void disconnect(ConnectRequest request, StreamObserver<CounterUpdate> responseObserver) {
        ...
        StreamObserver<CounterUpdate> observer = observers.remove(sessionId);
        if (observer != null) {
            ...
            responseObserver
                    .onError(Status.NOT_FOUND.withDescription("Invalid session ID: " + sessionId).asRuntimeException());
        }
    }
